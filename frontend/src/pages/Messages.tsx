...
const Messages = () => {
    ...
    return (
        <div className="flex max-h-screen dark:bg-black bg-white">
            {/* Left Side - Connection Names */}
            <div className="w-1/4 h-[80vh] bg-gray-100 border-r p-4 overflow-y-auto dark:text-white text-black dark:border-white border-black border-[1px] dark:bg-black">
                <h2 className="text-2xl font-semibold mb-4  dark:text-white text-black">Connections</h2>
